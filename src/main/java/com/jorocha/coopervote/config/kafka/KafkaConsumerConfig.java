...
public class KafkaConsumerConfig {
	...
	public ConsumerFactory<String, Associado> associadoConsumerFactory() {
		Map<String, Object> props = new HashMap<>();
		props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
		props.put(ConsumerConfig.GROUP_ID_CONFIG, associadoGroupId);
		props.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
		return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(),
				new JsonDeserializer<>(Associado.class));
	}

	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, Associado> associadoKafkaListenerContainerFactory() {
		ConcurrentKafkaListenerContainerFactory<String, Associado> factory = new ConcurrentKafkaListenerContainerFactory<>();
