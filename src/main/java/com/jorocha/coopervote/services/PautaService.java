...
public class PautaService {
	...
	/**
	 * Abertura da sess�o de votacao de uma pauta
	 * duracao m�nima de uma sess�o: 1 minuto
	 *
	 * @param idPauta
	 * @param numMinutos
	 * @return Pauta
	...
	public Pauta abrirSessao(String id, Integer numMinutos) {
		LOG.info(">>> Abertura de sess�o da pauta: ".concat(id));
	...
	/**
	 * Fechamento da sess�o de votacao de uma pauta
	 *
	 * @param idPauta
	 * @return Pauta
	 */	
	public Pauta fecharSessao(String id) {
		LOG.info(">>> Fechamento de sess�o da pauta: ".concat(id));
		Pauta pauta = findById(id);
	...
	/**
	 * Lista pautas por termo contido no titulo ou descri��o e entre um periodo de data
	 *
	 * @param text
	 * @param minDate
	 * @param maxDate
