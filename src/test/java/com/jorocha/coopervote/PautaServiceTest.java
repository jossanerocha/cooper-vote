...
public class PautaServiceTest {
	...
	public void deveriaInserirUmaListaDeAssociados() {	
		Pauta pauta1 = new Pauta(null, new Date(), "Reuni�o 001", "Descri��o 001", 5, LocalDateTime.of(2021, Month.JUNE, 21, 14, 33), LocalDateTime.of(2021, Month.JUNE, 21, 14, 45), new ArrayList<ItemPauta>());
		Pauta pauta2 = new Pauta(null, new Date(), "Reuni�o 002", "Descri��o 002", null, LocalDateTime.now(), LocalDateTime.now(), new ArrayList<ItemPauta>());
	...
	public void deveriaRetornarUmaPautaPorTermoContidoNoTitulo() {	
		List<Pauta> result = service.findByTitulo("Reuni�o");
		assertThat(result.size()).isEqualTo(2);
	}
	...
	public void deveriaRetornarUmaPautaPorTermoContidoNaDescricao() {	
	    ...
	    assertThat(pauta.getTitulo()).isEqualTo("Reuni�o 002");
	}	
